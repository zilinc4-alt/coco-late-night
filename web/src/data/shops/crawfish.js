...
export const crawfish = [
  ...
  {
    slug: 'crawfish-bistro',
    name: '剥壳放空小馆',
    category: 'crawfish',
    desc: '不用说话，不用社交，戴上手套就行了。',
    tags: ['今夜新店', '一人份友好', '虾肉已剥可选'],
    rating: 4.8,
    monthSold: '新店开张',
    avgPrice: 62,
    eta: [25, 42],
    isNew: true,
    coverGradient: ['#8b2a1a', '#d6583a'],
    coverEmoji: '🧤',
    image: img('crawfish-restaurant-cozy', 848),
    dishes: [
      { g: '招牌', name: 'mini麻辣小龙虾（半斤）', desc: '一个人，半斤刚好。不用客气地分给谁。', price: 38, sold: 320, image: img('mini-spicy-crawfish', 849) },
      { g: '招牌', name: 'mini蒜蓉小龙虾（半斤）', desc: '蒜香不分享，一个人闷头吃的那种。', price: 42, sold: 280, image: img('mini-garlic-crawfish', 850) },
      { g: '招牌', name: '虾球盖饭', desc: '剥好的虾球浇在白饭上，懒人最高待遇。', price: 48, sold: 400, image: img('crawfish-ball-rice', 851) },
      { g: '招牌', name: '剥好虾尾凉面', desc: '虾尾帮你剥好了，你只用把面拌匀。', price: 36, sold: 350, image: img('crawfish-tail-cold-noodle', 852) },
      { g: '小吃', name: '独饮小扎啤', desc: '大杯的一半，一人份的体面。', price: 12, sold: 600, image: img('small-draft-beer', 853) },
      { g: '小吃', name: '炸薯角配虾粉', desc: '薯角撒一层秘制虾粉，两样都不放过。', price: 22, sold: 280, image: img('potato-wedge-crawfish-powder', 854) },
      { g: '主食', name: '虾油拌饭', desc: '虾头炼的油浇在热饭上，香到隔壁桌转头看。', price: 24, sold: 450, image: img('crawfish-oil-rice', 855) },
      { g: '饮品', name: '白桃乌龙冰茶', desc: '虾辣完，桃子味把舌头安抚一下。', price: 16, sold: 380, image: img('white-peach-oolong-iced', 856) },
      { g: '饮品', name: '桂花冰粉', desc: '一勺冰粉滑过喉咙，像什么都没发生过。', price: 14, sold: 520, image: img('osmanthus-ice-jelly', 857) },
    ],
  },
]
